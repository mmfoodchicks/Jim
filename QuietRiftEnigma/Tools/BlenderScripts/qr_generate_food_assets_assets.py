...
Upgraded in Batch 4 of the Blender detail pass — every food item flows
...
Per-item sockets:
    SOCKET_PickupPoint  — where the player grabs the item
    SOCKET_EatPoint     — where the eat-anim mouth target lands
...
def gen_dray_meat():
    """Heavy slab from a Dray — thick dark cut with bone fragment."""
    clear_scene()
...
def main():
    print("\n=== Quiet Rift: Enigma — Food Asset Generator (Batch 4 detail upgrade) ===")
