"""
Quiet Rift: Enigma — Cosmetic Clothing Asset Generator (Blender 4.x)

Cosmetic-only clothing items added in Batch 4 of the Blender detail
pass. These are explicitly cosmetic — they have NO gameplay effect.
...
def gen_boots_tactical():
    ...
    _shoe_pair("Boots_Tactical", sole, upper, accent=upper, ankle_height=0.14,
...
def gen_shoes_tennis():
    ...
    _shoe_pair("Shoes_Tennis", sole, upper, accent=stripe, ankle_height=0.04,
...
def gen_shoes_running():
    ...
    _shoe_pair("Shoes_Running", sole, upper, accent=accent, ankle_height=0.04,
...
def main():
    print("\n=== Quiet Rift: Enigma — Cosmetic Clothing Asset Generator ===")
    ...
    print("These items are explicitly cosmetic-only — they have no gameplay effect.")
